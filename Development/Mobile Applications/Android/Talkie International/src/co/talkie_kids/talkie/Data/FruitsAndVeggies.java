...
public class FruitsAndVeggies implements TalkieObject {
	...
	private static int[] FRUITS_AND_VEGGIES_DRAWABLE_RESOURCES = { /*
																	 * R.drawable
																	 * .apple,
																	 * R.
																	 * drawable
	...
	private static int[] FRUITS_AND_VEGGIES_RAW_SOUND_RESOURCES = {
			R.raw.apple, R.raw.banana, R.raw.orange, R.raw.strawberry,
			R.raw.tomato, R.raw.potato, R.raw.pepper, R.raw.kiwi,
			R.raw.broccoli };

	private static String[] FRUITS_AND_VEGGIES_WORDS = { "apple", "banana",
			"orange", "strawberry", "tomato", "potato", "pepper", "kiwi",
			"broccoli" };
